        ...
        <div class="scrollable-content scrollable-slim-sidebar">
            <div class="pad10A">
                ...
                <ul class="chat-box">
                    <li>
                        <div class="status-badge">
                            <img class="img-circle" width="40" src="<?=$bundle->baseUrl?>/image-resources/people/testimonial1.jpg" alt="">
                    ...
                    <li>
                        <div class="status-badge">
                            <img class="img-circle" width="40" src="<?=$bundle->baseUrl?>/image-resources/people/testimonial2.jpg" alt="">
                            <div class="small-badge bg-green"></div>
                        </div>
                        <b>
                            Carl Gamble
                    ...
                    <li>
                        <div class="status-badge">
                            <img class="img-circle" width="40" src="<?=$bundle->baseUrl?>/image-resources/people/testimonial3.jpg" alt="">
                            <div class="small-badge bg-green"></div>
                        </div>
                        <b>
                            Michael Poole
                    ...
                    <li>
                        <div class="status-badge">
                            <img class="img-circle" width="40" src="<?=$bundle->baseUrl?>/image-resources/people/testimonial4.jpg" alt="">
                            <div class="small-badge bg-green"></div>
                        </div>
                        <b>
                            Bill Green
                    ...
                    <li>
                        <div class="status-badge">
                            <img class="img-circle" width="40" src="<?=$bundle->baseUrl?>/image-resources/people/testimonial5.jpg" alt="">
                            <div class="small-badge bg-green"></div>
                        </div>
                        <b>
                            Cheryl Soucy
                ...
                <ul class="chat-box">
                    <li>
                        <div class="status-badge">
                            <img class="img-circle" width="40" src="<?=$bundle->baseUrl?>/image-resources/people/testimonial6.jpg" alt="">
                    ...
                    <li>
                        <div class="status-badge">
                            <img class="img-circle" width="40" src="<?=$bundle->baseUrl?>/image-resources/people/testimonial7.jpg" alt="">
                            <div class="small-badge bg-orange"></div>
                        </div>
                        <b>
                            Dan Garcia
                    ...
                    <li>
                        <div class="status-badge">
                            <img class="img-circle" width="40" src="<?=$bundle->baseUrl?>/image-resources/people/testimonial8.jpg" alt="">
                            <div class="small-badge bg-orange"></div>
                        </div>
                        <b>
                            Edward Bridges
        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                ...
                <div class="container">
                    ...
                    <div id="page-title">
                        <h2><?=$this->title?></h2>
                        <p> <?= Breadcrumbs::widget([
                                'encodeLabels' => false,
                                'homeLink' => [
                                    'label' => '<i class="glyph-icon tooltip-button icon-typicons-home-outline"></i>Trang chủ',
